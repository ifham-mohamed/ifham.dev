  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="relative overflow-hidden rounded-xl border border-border bg-card/50 backdrop-blur-sm">
        ...
        <div className="relative flex flex-col items-center gap-5 p-8 md:p-10 text-center">
          <div className="inline-flex items-center gap-2 h-7 px-2.5 rounded-md border border-border bg-background/80 backdrop-blur text-xs font-medium text-foreground/80">
            <Mail className="size-3.5" aria-hidden />
            <span className="tabular-nums">{personalInfo.email}</span>
          </div>
