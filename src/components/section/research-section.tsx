...
export function ResearchSection() {
  ...
  return (
    <article className="group relative overflow-hidden rounded-lg border border-border bg-surface transition-colors hover:border-foreground/20 hover:bg-surface-hover focus-within:border-foreground/25">
      <div className="research-grid grid gap-0 md:grid-cols-[15rem_minmax(0,1fr)]">
        ...
        <div className="flex min-w-0 flex-col gap-4 bg-background/72 p-5 sm:p-6">
          ...
          <div className="grid grid-cols-2 gap-px overflow-hidden rounded-md border border-hairline bg-hairline sm:grid-cols-4">
            {enigmatrixResearch.metrics.map((metric) => (
              <div key={metric.label} className="bg-background px-3 py-2.5">
